...
{
    const char* pszTimestamp = "AspireGas Launched";
...
public:
    CMainParams() {
        ...
        consensus.checkpointPubKey = "038a6be3afda05cf6ef74140ec7868bd3d0d90475376f9ae0aa4ae39c8cd38b7eb";
        ...
        genesis = CreateGenesisBlock(1532325354, 918821, 0x1e0ffff0, 1, 0);
        ...
        vSeeds.push_back("gasp-1.gaspdns.com");
        vSeeds.push_back("gasp-1.aspirewallet.com");
        vSeeds.push_back("gasp-2.aspirewallet.com");
