...
const char * const BITCOIN_CONF_FILENAME = "gasp.conf";
const char * const BITCOIN_PID_FILENAME = "gasp.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "gAsp";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/gAsp";
#else
    // Unix
    return pathRet / ".gasp";
#endif
