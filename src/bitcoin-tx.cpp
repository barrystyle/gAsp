...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gasp-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gasp-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gasp transaction") + "\n" +
              "  gasp-tx [options] -create [commands]   " + _("Create hex-encoded gasp transaction") + "\n" +
              "\n";
